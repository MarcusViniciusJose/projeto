...
$count_sql = "SELECT COUNT(*) AS total FROM usuarios WHERE nome LIKE '%$search%'";
...
$sql = "SELECT * FROM usuarios WHERE nome LIKE '%$search%' LIMIT $limit OFFSET $offset";
          ...
          <div class="card">
            <div class="card-header">
              <h4>Usuários Cadastrados
                <a href="./forms/usuario-create.php" class="btn btn-primary float-end">Adicionar usuário</a>
              </h4>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td data-label="Data Nascimento"><?= date('d/m/Y', strtotime($usuario['data_nascimento'])) ?></td>
                        <td data-label="Cargo"><?= $usuario['cargo'] ?></td>
                        <td data-label="Login"><?= $usuario['login'] ?></td>
                        <td data-label="Ações">
                          <!--  Botões de ações na tabela -->
                          <a href="./forms/usuario-view.php?id=<?= $usuario['id'] ?>" class="btn btn-secondary btn-sm"><span class="bi-eye-fill"></span>&nbsp;Visualizar</a>
                          <a href="./forms/usuario-edit.php?id=<?= $usuario['id'] ?>" class="btn btn-success btn-sm"><span class="bi-pencil-fill"></span>&nbsp;Editar</a>
